...
from admin_pb2_grpc import OrderPortal, add_OrderPortalServicer_to_server
...
class OrderPortalServ(OrderPortal):
    def CreateOrder(self, request, context):
        try:
            ...
            order = admin_pb2.Order(OID=order_id, CID=request.CID, data=order_data)
